...
pub fn day1() -> u64 {
    ...
    let numlist = PuzzleInput::parse_content_to_numbers(crate::utils::get_filepath(filename));
    ...
    for idx in 1..numlist.len() {
        ...
        for i in 1..numlist.len() {
            ...
            for i in 1..numlist.len() {
                ...
                if crate::utils::is_sum_2020(vec![num1, num2, num3]) {
                    result = crate::utils::get_product(vec![num1, num2, num3])
                }
            }
        }
    }
...
pub fn day2() -> u32 {
    ...
    PuzzleInput::check_valid_passwords(crate::utils::get_filepath(filename))
}

pub fn day2_part2() -> u32 {
    let filename = "src/data/02.txt";
    PuzzleInput::check_valid_passwords_awkward(crate::utils::get_filepath(filename))
}
